...
After filling all Q1-Q19 scores, calculate a Data Quality Score (0-100) to assess confidence in the analysis.

### Scoring Criteria

| Component | Points | Criteria |
|:---|---:|:---|
| **Q1 (Player Values)** | 5 | Complete: 5pts, Partial: 2.5pts, Default: 1pt, Missing: 0pts |
| **Q2 (xG Data)** | 5 | Complete: 5pts, Partial: 2.5pts, Default: 1pt, Missing: 0pts |
| **Q3 (Bench Data)** | 3 | Complete: 3pts, Estimated: 1.5pts, Default: 1pt |
| **Q4 (xGA Data)** | 5 | Complete: 5pts, Partial: 2.5pts, Default: 1pt, Missing: 0pts |
| **Q5 (Manager History)** | 2 | Complete: 2pts, Default: 1pt |
| **Q6 (Formations)** | 5 | Confirmed: 5pts, Inferred: 2.5pts, Default: 1pt |
| **Q7 (Pressing Stats)** | 3 | Complete: 3pts, Inferred: 1.5pts, Default: 1pt |
| **Q8 (Set Pieces)** | 3 | Complete: 3pts, Partial: 1.5pts, Default: 1pt |
| **Q9 (League Context)** | 4 | Complete: 4pts, Estimated: 2pts |
| **Q10 (Derby/Context)** | 2 | Complete: 2pts, None: 2pts (N/A) |
| **Q11 (Form)** | 4 | Complete: 4pts |
| **Q12 (Opponent Quality)** | 4 | Complete: 4pts, Estimated: 2pts |
| **Q13 (xG Delta)** | 5 | Complete: 5pts, Estimated: 2.5pts |
| **Q14 (Ratings)** | 5 | Complete: 5pts, Partial: 2.5pts |
| **Q15 (Injuries)** | 4 | Complete: 4pts, Estimated: 2pts |
| **Q16 (Defensive Cluster)** | 4 | Complete: 4pts, Estimated: 2pts |
| **Q17 (Home/Away Form)** | 4 | Complete: 4pts |
| **Q18 (H2H)** | 4 | Complete: 4pts |
| **Q19 (H2H Negative)** | 4 | Complete: 4pts |
| **Betfair Draw Odds** | 10 | Available: 10pts, Missing: 0pts |
| **Betfair AH Market** | 10 | Available: 10pts, Missing: 0pts |
| **Local Media** | 5 | Available: 5pts, Missing: 0pts |
| **SportsMole Preview** | 5 | Available: 5pts, Missing: 0pts |
...
Score 70-84: "Good" - Normal confidence
Score 60-69: "Acceptable" - Proceed with caution
Score < 60: "Poor" - Consider SKIP
```

### Critical Missing Data (Auto-SKIP)

If ANY of these are missing, output `"proceed": false`:

- ❌ Q1 (Player values) - Cannot assess quality
- ❌ Q2 (G/J or xG) - Cannot assess offense
- ❌ Q4 (GA/J or xGA) - Cannot assess defense
- ❌ Q11 (Form last 5) - Cannot assess recent performance
- ❌ Q17 (Home/Away form) - Cannot assess venue advantage
- ❌ Betfair AH Market - Cannot calculate edge

### Output Format with Quality Scoring
...
```json
{
  ...
  "data_quality": {
    ...
    "breakdown": {
      "q1_player_values": {"points": 5, "status": "complete"},
      "q2_xg": {"points": 5, "status": "complete"},
      "q3_bench": {"points": 1.5, "status": "estimated"},
      "q4_xga": {"points": 5, "status": "complete"},
      "q5_manager": {"points": 2, "status": "complete"},
      "q6_formations": {"points": 5, "status": "confirmed"},
      "q7_pressing": {"points": 1, "status": "default"},
      "q8_set_pieces": {"points": 1.5, "status": "partial"},
      "q9_league": {"points": 4, "status": "complete"},
      "q10_derby": {"points": 2, "status": "complete"},
      "q11_form": {"points": 4, "status": "complete"},
      "q12_opponent": {"points": 4, "status": "complete"},
      "q13_xg_delta": {"points": 5, "status": "complete"},
      "q14_ratings": {"points": 5, "status": "complete"},
      "q15_injuries": {"points": 4, "status": "complete"},
      "q16_cluster": {"points": 4, "status": "complete"},
      "q17_home_away": {"points": 4, "status": "complete"},
      "q18_h2h": {"points": 4, "status": "complete"},
      "q19_h2h_negative": {"points": 4, "status": "complete"},
      "betfair_draw": {"points": 10, "status": "available"},
      "betfair_ah": {"points": 10, "status": "available"},
      "local_media": {"points": 0, "status": "missing"},
      "sportsmole": {"points": 5, "status": "available"}
    },
    "missing_critical": [],
    "proceed": true,
    "confidence_note": "Excellent data quality. Only missing local media and Q7 pressing stats used default."
  },

  "notes": [
    "Q7: Pressing stats unavailable - used default +2",
    "Local media not found for this match",
    "All critical data sources available"
  ]
}
```

### Example: Low Quality (Should Skip)

```json
{
  "game_id": "LOWQ_20251115_XYZ_ABC",
  "data_quality": {
    "score": 45,
    "assessment": "Poor",
    "missing_critical": [
      "Q1: No player values from Transfermarkt",
      "Q2: No xG data available",
      "Betfair: No AH market found"
    ],
    "proceed": false,
    "confidence_note": "Insufficient critical data. Cannot reliably analyze this match."
  },
  "recommendation": "SKIP - Insufficient data quality for reliable analysis"
}
```
...
**Remember**: Your role is to be DETERMINISTIC and CONSISTENT. Always follow the criteria exactly. When in doubt, use defaults and document. The main Yudor prompt depends on your accuracy. Always include data_quality scoring in your output.
